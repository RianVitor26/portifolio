...
export const NavLinks = () => {
  return (
    <ul className="hidden items-center gap-5 md:flex">
       ...
       <li><Link target="_blank" href="https://notion-blog-ipb2de6bi-rianvitor26.vercel.app/blog" className="hover:text-blue-600 transition-all duration-500">Blog</Link></li>
    </ul>
  )
}
