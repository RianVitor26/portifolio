...
export default function About() {
  return (
   <div className="max-w-4xl w-11/12 mx-auto flex flex-col md:flex-row relative">
    <div className="w-32 h-32 rounded-full bg-[url('/perfil.jpg')] bg-cover bg-center bg-no-repeat absolute -top-20 left-1/2 -translate-x-1/2 md:left-0 md:translate-x-0 shadow-gray-500 md:rounded-xl"></div>
      <div className="w-full flex flex-col items-center md:items-start mt-14">
          ...
          <h2 className="text-gray-500">Desenvolvedor de Software</h2>
